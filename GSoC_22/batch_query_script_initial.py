...
if __name__=='__main__':
    ...
    raw_dataset = tf.data.TFRecordDataset("./gazetrack_tfrec/train.tfrec")
    ...
    for features in parsed_dataset.take(total_count): 
        ...
        p_count = p_count + 1
        #print(p_count,'\n')
        if p_count%5000 == 0: print(p_count) 
    ...
    path_csv = '/home/skrishna/projects/def-skrishna/shared/suresh_train_data_slurm.csv'
