...
if __name__=='__main__':
    ...
    #    ry = ry + rh
        ...
        left_bbx = normalize_bbco([lx, ly, lw, lh],fw,fh)
        right_bbx = normalize_bbco([rx, ry, rw, rh],fw,fh)        
    ...
    path_csv = '/home/skrishna/projects/def-skrishna/shared/v4b_10individuals_data.csv'
