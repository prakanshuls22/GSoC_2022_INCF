...
if __name__=='__main__':
    ...
    for features in parsed_dataset.take(total_count): 
        ...
        eye_dist = (math.dist([lx_c_point,ly_c_point],[rx_c_point,ry_c_point]))  ##undivide later if neccessary
    ...
    path_csv = '/home/skrishna/projects/def-skrishna/shared/v3_10individualsTESTING_data.csv'
